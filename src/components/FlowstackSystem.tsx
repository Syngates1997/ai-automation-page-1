  ...
  return (
    <section id="flowstack-system" className="py-20 md:py-28">
      <div className="container">
        ...
        {/* Stage Overview Bar - AUSGEBLENDET (verursachte Doppel-Anzeige mit Timeline)
        <div className="hidden lg:flex justify-center items-center gap-4 mb-16 max-w-5xl mx-auto">
